...
- DHCP snooping trust is applied only where DHCP replies should legitimately travel, with rogue-server testing on `ASW1` and rate-limit testing on Host 4 connected to `ASW2`.
